...
echo (styled "[aliases] …loading command [aliases]…" bold italic green)
...
set edit:small-word-abbr['ll'] = 'lsd -alFGh@'
set edit:small-word-abbr['ls'] = 'lsd -GF'
...
edit:add-var updateOptickaPages~ {
	...
	if (cmds:is-path $opath) {
		...
		#cd $olddir
		echo "[elvish/aliases] Updated gh-pages from README.md"
		echo "[elvish/aliases] Check and push manually…"
	}
}
